...
<div class="container">
    ...
    <p class="text-center"><br><b>Note:</b>Your reservation will be available for 1 hour only after successfull payment for reservation.If you cancel reservation amount paid is not refundable.</P>
      <h3 class="text-center"><b>Exclusive offer:</b>  10 % discount on order <br></H3>
  ...
  //error handling:
    ...
    <div class="signup-form">
        <form action="includes/reservation.inc.php" method="post">
            ...
            <div class="form-group">
		<label>Enter Time of enjoying your coffee</label>
    ...
    <option>21:00 - 22:00</option>
            ...
            <label for="guests">Enter your Telephone Number</label>
                ...
                <small class="form-text text-muted">Telephone must be 10-15s characters long</small>
            </div>
            <div class="form-group">
		...
		<label class="checkbox-inline"><input type="checkbox" required="required"> I accept the <a href="#">Terms of Use</a> &amp; <a href="#">Privacy Policy</a></label>
            ...
            <div class="form-group">
            <button type="submit" name="reserv-submit" class="btn btn-dark btn-lg btn-block">Pay for booking</button>
            </div>
        </form>
        <br><br>
    </div>
