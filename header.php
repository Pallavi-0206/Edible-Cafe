...
<html lang="en">
<head>
<link rel="icon" type="image/png" sizes="32x32" href="img/favicon.png">    <!--favicon-->
<title>Edible Gold Cafe</title>
<meta charset="utf-8">
 <meta name="viewport" content="width=device-width, initial-scale=1">
  <link href="C:\xampp\htdocs\Cafe\Restaurant-Reservation\css\style.css" rel="stylesheet" type="text/css">     <!--style.css document-->
  ...
  <script src="https://kit.fontawesome.com/42b4b14be9.js" crossorigin="anonymous"></script>  <!--font-awesome-->
...
<body>
<nav class="navbar navbar-expand-md navbar-light fixed-top" style="background-color: #4D3E3E; color: #FFD700;">


        <div class="container">
            <a class="navbar-brand" href="index.php" style="color:#4D3E3E; font: Satisfy;">
		<strong><em>Edible Gold Cafe</em></strong>
            </a>
    ...
    <!---sign up form -->
                    <div class="signup-form">
                        <form action="includes/signup.inc.php" method="post">
                            ...
                            <div class="form-group">
                                <label class="checkbox-inline"><input type="checkbox" required="required"> I accept the <a href="#">terms and condition.I also accept the </a> &amp; <a href="#">Privacy Policy</a></label>
                            </div>
                            <div class="form-group">
